...
//        Civilization.Database.GameDatabase.turn = 0;
//        Civilization.Database.GameDatabase.year = 0;
//        Civilization.Database.GameDatabase.cheated = false;
//        Civilization.Database.GameDatabase.cheatedCivilization = null;
//        Civilization.Database.GameDatabase.players = players;
//        TransitionDatabase.restart();
//        for (Civilization civilization : players) {
//            civilization.setHappiness(GlobalVariables.firstHappiness * Civilization.Database.GameDatabase.players.size());
...
//        for (int i = 0; i < Civilization.Database.GameDatabase.players.size(); i++) {
//            if (Civilization.Database.GameDatabase.players.get(i).getUsername().equals(civilizationName)) {
//                return Civilization.Database.GameDatabase.players.get(i);
//            }
//        }
//        return null;
//    }
...
//        for (int i = 0; i < Civilization.Database.GameDatabase.players.size(); i++) {
//            if (Civilization.Database.GameDatabase.players.get(i).getNickname().equals(civilizationName)) {
//                return Civilization.Database.GameDatabase.players.get(i);
//            }
//        }
//        return null;
...
//        for (int i = 0; i < Civilization.Database.GameDatabase.players.size(); i++) {
//            for (int j = 0; j < Civilization.Database.GameDatabase.players.get(i).getCities().size(); j++) {
//                if (Civilization.Database.GameDatabase.players.get(i).getCities().get(j).getName().equals(cityName)) {
//                    return Civilization.Database.GameDatabase.players.get(i).getCities().get(j);
//                }
//            }
//        }
//        return null;
...
//        for (Civilization player : Civilization.Database.GameDatabase.players) {
...
//        return Civilization.Database.GameDatabase.map;
//    }
//
//
...
//        for (Civilization civilization : Civilization.Database.GameDatabase.players) {
...
//        for (int i = 0; i < Civilization.Database.GameDatabase.players.size(); i++) {
//            for (int j = 0; j < Civilization.Database.GameDatabase.players.get(i).getTiles().size(); j++) {
//                if (Civilization.Database.GameDatabase.players.get(i).getTiles().get(j).equals(tile)) {
//                    return Civilization.Database.GameDatabase.players.get(i);
//                }
//            }
//        }
...
//        if (turn != Civilization.Database.GameDatabase.players.size() - 1) {
//            return turn + 1;
//        }
//        year++;
//        return 0;
...
//        return Civilization.Database.GameDatabase.players.get(turn);
//    }
//
...
//        return Civilization.Database.GameDatabase.players;
//    }
//
...
//        if (Civilization.Database.GameDatabase.year >= 2050) {
//            return Civilization.Database.GameDatabase.getCivilizationByTurn(Civilization.Database.GameDatabase.getTurn());
//        }
//        if (Civilization.Database.GameDatabase.cheated && Civilization.Database.GameDatabase.cheatedCivilization != null) {
...
//        int turn = Civilization.Database.GameDatabase.getTurn();
//        if (turn == 0) {
//            return Civilization.Database.GameDatabase.getCivilizationByTurn(Civilization.Database.GameDatabase.players.size() - 1);
//        }
//        return Civilization.Database.GameDatabase.getCivilizationByTurn(turn - 1);
//    }
//
//
//}
