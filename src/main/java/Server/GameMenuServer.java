...
//
//public class GameMenuServer extends Menu {
//
...
//
//
//    public GameMenuServer(GameMenuController gameMenuController, CombatController combatController) {
...
//    }
//
//    public JSONObject processGameMenuReqs(JSONObject clientCommandJ, DataOutputStream dataOutputStream) {
//        System.out.println(GameDatabase.getPlayers().get(0).getNickname());
//        String command;
//        Info info = Info.getInstance();
//        boolean nextTurnIsCalled = false;
//
//        //////////////////////////// while loop in the actual game menu
//        JSONObject response = new JSONObject();
//        nextTurnIsCalled = false;
//        numberOfPlayers = GameDatabase.players.size();
//        Matcher matcher;
//        command = (String) clientCommandJ.get("action");
//        if (command.equals(CHEAT_WIN)) {
//            response.put("action","declare winner");
//            response.put("winner",GameDatabase.getPlayers().get(turn));
...
//            response.put("action","show menu");
//            response.put("menu",menuShow());
//        } else if ((matcher = getCommandMatcher(command, MENU_ENTER)) != null) {
//            response.put("action","show menu");
//            response.put("menu enter",menuEnter(matcher));
...
//        if (!gameMenuController.isTileInCivilization(tile, turn % numberOfPlayers))
//            return "this isn't in your civilization";
...
//        if (GameDatabase.getPlayers().get(turn).getNickname().equals(nickname))
